...
class App extends Component {
  ...
  generatePDF = () => {
    ...
    const title = pdf.splitTextToSize(
      this.state.fname ? this.state.fname : "Bio Data",
      180
    );
      ...
      switch (item) {
        case "fname":
          ...
          const name = pdf.splitTextToSize(
            this.state.fname ? this.state.fname : "N/A",
            70
          );
          pdf.text(50, 45, name);
          break;
        case "dob":
          ...
          pdf.setFontStyle("italic");
          pdf.text(
            `${new Date(this.state.dob).getDate()} ${new Date(
              this.state.dob
        ...
        case "height":
          ...
          pdf.setFontStyle("italic");
          const feet = (parseFloat(this.state.height) / 30.48)
            .toFixed(1)
            .split(".")[0];
          const inches = (parseFloat(this.state.height) / 30.48)
            .toFixed(1)
            .split(".")[1];
        ...
        case "siblings":
          pdf.setFontStyle("bold");
          pdf.text("Siblings", 10, 190);
          pdf.setFontStyle("italic");
          pdf.text(this.state.siblings, 50, 190);
          break;
        case "maternalInfo":
          pdf.setFontStyle("bold");
          pdf.text("Maternal Info", 10, 200);
          pdf.setFontStyle("italic");
          pdf.text(this.state.maternalInfo, 50, 200);
          break;
        case "contactInfo":
          pdf.setFontStyle("bold");
        ...
        <div className="container text-center">
          <form onSubmit={this.handleSubmit}>
            <div className="form-group">
              ...
              <input
                className="input-text form-control wd-50 i_50"
                type="text"
                name="fname"
            ...
            <div className="form-group">
              ...
              <input
                className="input-text form-control wd-25 i_50"
                type="date"
                name="dob"
                onChange={this.handleChange.bind(this)}
                required
            ...
            <div className="form-group">
              ...
              <input
                className="input-text form-control wd-25 i_50"
                type="number"
                placeholder="Height in Centimeter (Cms)"
                name="height"
                onChange={this.handleChange.bind(this)}
                required
              />
            ...
            <div className="form-group">
              ...
              <input
                className="input-text form-control wd-25 i_50"
                type="number"
                placeholder="Weight in Kilograms (Kgs)"
                name="weight"
                onChange={this.handleChange.bind(this)}
                required
              />
            ...
            <div className="form-group">
              ...
              <select
                className="form-control custom-select input_text wd-50"
                onChange={this.handleChange.bind(this)}
                required
                name="status"
              >
            ...
            <div className="form-group wd-50 i_50">
              ...
              <div className="custom-file">
                <input
                  type="file"
                  className="custom-file-input wd-25"
                  id="customFile"
                  name="file"
                  onChange={this.fileHandle.bind(this)}
                  required
                />
                <label className="custom-file-label" htmlFor="customFile">
                  {this.state.imgName ? this.state.imgName : "Choose file"}
                </label>
              </div>
            </div>
            <button
